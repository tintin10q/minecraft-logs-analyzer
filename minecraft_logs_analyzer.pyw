...
from tkinter import Tk, Entry, Button, StringVar, Label, Toplevel, mainloop, Frame, IntVar, Radiobutton, Message ,Text ,messagebox, END
...
def create_graph():
    ...
    try:
        if graph_data_collection == {}:
            insert("Not enough data to create a graph")
            return
...
if __name__ == '__main__':
    ...
    root.title("Playtime calculator")
    ...
    # graph button
    graphButton = Button(frame, text="Create graph",command=create_graph, cursor="hand2",bg=background_color,fg=fg_color,font="Helvetica 10")
